            ...
            <Col lg="12">
              ...
              <div className="mt-4">
                ...
                <div className="cart__page-btn">
                  ...
                  <button className="addTOCart__btn"><Link to='/checkout'>Proceed to chekout</Link></button>
                </div>
              </div>
            </Col>
          </Row>
...
const Tr = (props) => {
  ...
  return (
    <tr>
      <td className="text-center"><img src={image01} className="text-center cart__img-box" alt="" /></td>
